            ...
            <tbody>
                ...
                <tr class="odd:bg-white even:bg-gray-50 border-b border-gray-200 hover:bg-gray-100 transition">
                    ...
                    <td class="px-6 py-4 flex items-center gap-4">
                        <a href="{{ route('admin.nurseInfo', $nurseId) }}"
                            class="text-blue-600 hover:underline font-medium">
                            View
                        </a>
                        <a href="{{ route('admin.nurse.edit', $nurseId) }}"
                            class="text-green-600 hover:underline font-medium">
                            Edit
                        </a>
                        <x-delete-button
                            :route="route('admin.nurse.delete', $nurseId)"
